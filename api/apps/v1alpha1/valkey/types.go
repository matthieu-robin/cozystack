...
type ConfigSpec struct {
	...
	// Explicit CPU and memory configuration for each Valkey replica. When omitted, the preset defined in `resourcesPreset` is applied.
	// +kubebuilder:default:={}
	...
	// Valkey major version to deploy
