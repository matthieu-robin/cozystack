...
Forklift migrates VMs from VMware vSphere to KubeVirt, with automatic guest conversion via virt-v2v (virtio drivers installation, guest OS adaptation).
...
| Name                  | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Type       | Value   |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------- |
| `skipGuestConversion` | Skip virt-v2v guest conversion and copy the disk as-is (raw-copy mode). Faster and avoids the privileged virt-v2v conversion pod, but the guest OS must already contain virtio drivers. Requires the platform administrator to have configured the VDDK image (`vddk-image` in the cozystack ConfigMap).                                                                                                                                                                                                                                                                                                                                  | `bool`     | `false` |
| `xfsCompatibility`    | Use the XFS-capable virt-v2v image and omit the `--no-fstrim` flag. Works around an upstream Forklift inconsistency where the conversion entrypoint passes `--no-fstrim` to a `virt-v2v-inspector` that does not support it, which otherwise fails the migration after a successful disk conversion.                                                                                                                                                                                                                                                                                                                                      | `bool`     | `false` |
